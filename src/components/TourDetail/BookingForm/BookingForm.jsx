...
const ZaloButton = ({ phoneNumber, label, style }) => (
  <a
    ...
    style={style.zaloButton}
  >
    <img
      src="https://res.cloudinary.com/dp15bjk0a/image/upload/v1759972785/2048px-Icon_of_Zalo.svg_eyypss.png"
      alt="Zalo Icon"
      style={style.zaloIcon}
    />
    {label}
  </a>
);
...
const BookingForm = ({ tourPrice, tourId, onQuantityChange }) => {
  ...
  const initialFormData = {
    ...
    scheduleId: "",
    notes: "",
    totalAmount: tourPrice * quantity,
  };
  ...
  return (
    <>
      ...
      <div
        style={{
          ...styles.modalOverlay,
          ...(showModal && styles.modalOverlayActive),
        }}
      ...
      >
        <div
          style={{
            ...
            ...(showModal && styles.modalContainerActive),
          }}
        ...
        >
          ...
          <div style={styles.modalBody}>
            ...
            <div style={styles.formGroup}>
              <label htmlFor="scheduleId" style={styles.formLabel}>
                Ngày khởi hành *
              </label>
              <div style={styles.inputWithIcon}>
                ...
                >
                  ...
                  {!isLoadingSchedules && schedules.length === 0 && !error && (
                    <option disabled>Không có lịch trình</option>
                  )}
                  {schedules.map((s) => (
                    <option
                      key={s.scheduleId}
            ...
            <div style={styles.formGroup}>
              <label htmlFor="quantity-display" style={styles.formLabel}>
                Số lượng người
              </label>
              <div style={styles.inputWithIcon}>
            ...
            <div style={styles.formGroup}>
              <label htmlFor="note" style={styles.formLabel}>
                Ghi chú
              </label>
              <div style={styles.inputWithIcon}>
